...
CREATE TABLE public.bin_cache (
  ...
  scheme TEXT, brand TEXT, card_type TEXT, category TEXT,
  bank_name TEXT, bank_url TEXT, bank_phone TEXT,
  country_name TEXT, country_code TEXT, country_emoji TEXT,
  currency TEXT, prepaid BOOLEAN, commercial BOOLEAN,
  raw JSONB,
...
AS $$
DECLARE admin_count int; uid uuid;
BEGIN
  uid := auth.uid();
